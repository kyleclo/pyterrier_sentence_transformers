...
Config for running experiments with document expansion (i.e. Hyde)
...
TASK_SETUP = "fake_books"
STA_MODEL_NAME = "BM25"
NEU_MODEL_NAME = "facebook/contriever-msmarco"

# raw data paths
data_dir = "/net/nfs2.s2-research/kylel/whatsthatbook/data/"
raw_bookspath = os.path.join(
    data_dir, "2022-05-30_ours_books_chatgpt_2023-03.jsonl"
)
